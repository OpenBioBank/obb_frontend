...
async function callContract() {
  try {
    ...
    const instructionData = new InitializeTokenMintArgs({
            methods_id: 0,
            id: 81,
            description: "this is a nft this is a nftthis is a nftthis is a nftthis is a nftthis is a nftthis is a nftthis is a nftthis is a nftthis is a nftthis is a nftthis is a nftthis is a nftthis is a nftthis is a nftthis is a nft",
   ...
   console.log("初始化签名: ", signature)
    ...
    // 步骤二 创建NFT
    const userAta = await getAssociatedTokenAddress(tokenMint, phantom.publicKey);
